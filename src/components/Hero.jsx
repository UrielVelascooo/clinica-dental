...
const styles = {
  ...
  content: { width: "100%", maxWidth: "800px" },
  badge: {
    display: "inline-flex",
    alignItems: "center",
    gap: "10px",
  ...
  text: { fontSize: "clamp(1rem, 4vw, 1.25rem)", lineHeight: "1.8", color: "#52606d", maxWidth: "550px", marginBottom: "50px" },
  ...
  bgShape1: { position: "absolute", width: "100%", maxWidth: "800px", height: "800px", background: "rgba(144, 224, 239, 0.15)", borderRadius: "50%", top: "-200px", right: "-200px", filter: "blur(80px)", zIndex: 0 },
  bgShape2: { position: "absolute", width: "100%", maxWidth: "500px", height: "500px", background: "rgba(0, 180, 216, 0.08)", borderRadius: "30% 70% 70% 30% / 30% 30% 70% 70%", bottom: "-100px", left: "-100px", filter: "blur(60px)", zIndex: 0 },
  bgShape3: { position: "absolute", width: "300px", height: "300px", border: "2px solid rgba(0, 180, 216, 0.1)", borderRadius: "50px", top: "20%", right: "15%", transform: "rotate(15deg)", zIndex: 0 }
};
